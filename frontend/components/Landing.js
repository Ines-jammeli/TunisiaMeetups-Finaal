  ...
  return (
    <div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 d-none d-lg-block">
              <ul className="list-inline text-center mb-0 mt-2 pt-1">
                ...
                {/* <li className="list-inline-item pe-4 ps-4">
                  <Link className="scroll-tiger" href="#demo">
                    Demo
                  </Link>
                </li> */}
                <li className="list-inline-item pe-4 ps-4">
      ...
      {/* <div className="section demo-style" id="mobile">
        <div className="container max-container">
          <div
            className="col-lg-12 p-5 rounded-3 bscover"
            style={{
              backgroundImage: `url("assets/images/demo/mobile-banner-2.png")`,
            }}
          >
            <div className="container">
              <div className="row">
                <div className="col-lg-5 mt-5 mb-5">
                  ...
                  <p>
                    With beautifully designed custom post types to show off your
                    works and collections.Sociala powers thousands of apps at
                    some of the smartest companies around the world. Be a part
...
//                 <li className="list-inline-item pe-4 ps-4">
//                   <Link href="/#feature">
//                     <a className="scroll-tiger">Features</a>
//                   </Link>
//                 </li>
//                 <li className="list-inline-item pe-4 ps-4">
...
//         className="banner-wrapper vh-100 bscover demo-style"
//         style={{
//           backgroundImage: `url("assets/images/demo/banner-bg-1.png")`,
//         }}
//       >
//         <div className="banner-content">
//           <div className="container max-container">
...
//             <div className="col-lg-5 offset-lg-1">
//               <h2 className="title-text2 mb-4 mt-5">
//                 <b>Awesome Components Ready Elements and Templates.</b>
//               </h2>{" "}
//               <p>
//                 Sociala powers thousands of apps at some of the smartest
//                 companies around the world. Be a part of professional community.
//               </p>
//               <a
//                 href="#demo"
//                 className="btn btn-lg btn-primary mr-4 text-uppercase mt-4"
